class MyNotes {
  ...
  addEventListeners() {
    ...
    this.deleteAllBtn.addEventListener("click", () => this.deleteAllNote());
  }
  ...
  checkColor = (note) => {
    ...
    switch (this.cat) {
      ...
      case "Dom":
        ...
        break;
      case "Zakupy":
        note.style.backgroundColor = "rgb255, 243, 0)";
        break;
      case "Inne":
  ...
  deleteNotes = (id) => {
    this.deleteNoteBtn = this.NoteArea.querySelectorAll(this.UiSelectors.note);
    this.deleteNoteBtn.forEach((el) => {
      el.addEventListener("click", function () {
        this.parentNode.removeChild(el);
        console.log("usunąłem notatke");
      });
    });
  };
  deleteAllNote() {
    console.log("usunę wszystkie elementy");
    const aaa = this.NoteArea.querySelectorAll(this.UiSelectors.note);
    console.log(aaa);
    aaa.parentNode.removeChild();
  }
  //this.NoteArea.removeChild(noteToDelete);
