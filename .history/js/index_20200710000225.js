class MyNotes {
  ...
  initializeMyNotes() {
    ...
    this.Note = document.querySelector(this.UiSelectors.note);
  ...
  checkColor = () => {
    switch (this.cat) {
      case "Praca":
        this.Note.style.backgroundColor = "rgb(72, 255, 0)";
        break;
      case "Dom":
        this.Note.style.backgroundColor = "rgb(232, 110, 34)";
        break;
      case "Zakupy":
        this.Note.style.backgroundColor = "rgb(41, 34, 232)";
        break;
      case "Inne":
        this.Note.style.backgroundColor = "rgb(162, 23, 178)";
        break;
    }
  };
}
