class MyNotes {
  ...
  deleteNotes = (id) => {
    ...
    console.log(this.deleteNoteBtn);
    this.deleteNoteBtn.forEach((el) => {
      el.addEventListener("click", function () {
        console.log(el);
        let noteArea2 = document.querySelector(".note-area");
        console.log(noteArea2);
        const noteToDelete = el;
        noteArea2.removeChild(noteToDelete);
        console.log(noteArea2);
      });
    });
  };
